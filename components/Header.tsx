...
export default function Header() {
  ...
  const { phoneDisplay, phoneTel } = useSettings();
    ...
    >
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "12px 20px", display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div className="animate-slide-right delay-300" style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0, marginLeft: "auto" }}>
          ...
          <a href={`tel:${phoneTel}`} className="btn-solid sm call-btn">
            ...
            <span className="call-btn-label" style={{ fontFamily: "'Geist Mono', monospace", letterSpacing: "-0.02em" }}>{phoneDisplay}</span>
          </a>
        </div>
      </div>
    </header>
